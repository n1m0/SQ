  ...
  <div class="contain" id="tabs" style="margin:0 auto;">
    <div class="text-nav">
      <ul class="clearfix">
        ...
        <li class="selected"> <a class="text-link" href="资费说明/home">资费说明</a> </li>
    ...
    <div class="text-box">
			<div class="text-content" id="text-content">
				...
				<p class="mt10 cn_line">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. SQ金服郑重承诺：如投资者未能获得利息，SQ金服将启动“赔付宝”本息安全保障计划，按照《“赔付宝”资金使用规则》对投资者的本金及利息进行垫付，除居间服务费外，网站不向投资人收取其他费用。
				</p>
				<p>
					<br>
				</p>
				<p class="mt10 cn_line">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. 提现费用：SQ金服不向平台会员收取任何提现费用，仅代为收取第三方平台（环迅支付）应缴纳的提现费用。 <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;普通会员提现时按照额度，每笔收取提现金额的千分之三（0.3%），上不封顶。 <br>
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span style="color:#e53333;">SQ金服VIP会员缴纳年费后，将免费提现</span>，由SQ金服支付应向第三方平台（环迅支付）缴纳的提现费用。 
				</p>
				<p>
					<br>
				</p>
				<p class="mt10 cn_line">
					...
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1. 凡是在SQ金服平台注册的用户，自动成为SQ金服普通会员，<span style="color:#e53333;">普通会员免会员费。</span><br>
