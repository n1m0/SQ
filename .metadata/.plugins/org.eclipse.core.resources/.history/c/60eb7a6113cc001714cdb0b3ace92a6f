	...
	<div class="w1200 personal">
        ...
        <div id="personal-left" class="personal-left">
        	<ul>
	            ...
	            <li><span><a href="trans/PersonalCenter/OpenThirdParty/${sqUser.user_id }"><i class="dot dot02"></i>开通第三方</a></span></li>
                <li class="pleft-cur"><span><a href="trans/PersonalCenter/Recharge/${sqUser.user_id }/2"><i class="dot dot3"></i>充值</a></span></li>
                <li><span><a href="trans/PersonalCenter/Withdraw/${sqUser.user_id }/2"><i class="dot dot04"></i>提现</a></span></li>
