...
<script src="script/alterPassword.js" type="text/javascript"></script>
</head>
<body>
<header>
    ...
    <div class="registerCont">
      <ul>
        ...
        <li><span class="dis">确认密码:</span>
          ...
          <span id="repeatPasswordAlt" data-info="请再次输入密码">请输入确认密码</span></li>
        <li> <span class="dis">验证码:</span>
          <input type="text" id="jpgVerify" class="input input1 _yanzhengma" name="yzm" maxlength="4" tabindex="1">
          <img id="vimgs" alt="" src="createCode"> <a class="look blue _changeCapcherButton" id="vimg" href="javascript:void(0);" >看不清？换一张</a> <span class="info" id="jpgVerifys" data-info="请输入手机验证码"></span> </li>
        <li class="agree">
