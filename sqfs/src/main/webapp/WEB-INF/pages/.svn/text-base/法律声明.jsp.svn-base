  ...
  <div class="contain" id="tabs" style="margin:0 auto;">
    <div class="text-nav">
      <ul class="clearfix">
        ...
        <li class="selected"> <a class="text-link" href="法律声明/home">法律声明</a> </li>
    ...
    <div class="text-box">
			<div class="text-content" id="text-content">
				...
				<p class="cn_line mt5">
					本声明包含访问和使用SQ金服（<a href="http://www.yirenbao.com/">www.yirenbao.com</a>）的有关注意事项，在您访问和使用本网站之前，请务必仔细阅读本声明。 您若要访问和使用本网站（<a href="http://www.yirenbao.com">www.yirenbao.com</a>），请务必仔细阅读本声明中所包含的条款和本网站即时刊登的通告，并且遵守有关互联网及/或本网站的相关法律、规定与规则。若您不同意本声明内容，建议立即离开本网站。一旦您访问、使用了本网站，即视为您同意并接受了所有该等条款及通告。
				</p>
				<p class="cn_line">
					<br>
				</p>
				...
				<p class="cn_line">
					5.2 对本声明的修订将不会进行预先的通知或公告，修订结果只在SQ金服平台网站上进行公布，不另行通知会员个人。
				</p>
				<p class="cn_line">
